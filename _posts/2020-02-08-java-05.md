...
[1.2 바깥쪽 유효 범위에 속한 변수 접근하기](#12-바깥쪽-유효-범위에-속한-변수-접근하기)
[2. 고차함수](#2-고차함수)
[2.1 함수를 반환하는 메서드](#21-함수를-반환하는-메서드)
[2.3 Comparator 인터페이스의 메서드](#23-Comparator-인터페이스의-메서드)
<br><br>
...
앞서 본 메서드는 오름차순과 낼미차순 문자열 비교자를 돌려준다.
